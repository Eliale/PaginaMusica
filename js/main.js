    ...
    xhttpt.onreadystatechange = function () {
        if (xhttpt.readyState === 4 && xhttpt.status === 200) {
            ...
            for (var i = 0; i < mejores_canciones.length; i++) {
               ...
               // $("#topten").append("<input type='image' name='" + nombre + "' SRC='" + mejores_canciones[i].image[4]["#text"] + "' ALT='" + mejores_canciones[i].name + "' WIDTH=40 HEIGHT=40 onclick= 'busquedaTable(this)'>");
